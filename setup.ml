...
(* OASIS_START *)
(* DO NOT EDIT (digest: 78013675038faa464b39fac53208dc77) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "An RLP (Recursive Length Prefix) serialization library. RLP can encode recursive lists of\nbytesequences into a bytesequence.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("rope", None)];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "rlp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "testRlp.ml"});
               Test
                 ({
                     cs_name = "runTestRlp";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "test-rlp"]
                   })
            ];
     ...
     oasis_digest = Some "3R\199\005d\199Y\140\231]Z\020k5y\194";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
