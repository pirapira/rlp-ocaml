...
(* OASIS_START *)
(* DO NOT EDIT (digest: aabe39c62edbadecef5e9adcdbb12c52) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "An RLP serialization library. RLP can encode recursive lists of\nbytesequences into a bytesequence.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\002\017\244\151H\216\139H\154\151\147\2520\171rA";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
